...
const CartItem = ({ item, index }: CartItemProps) => {
  ...
  return (
    <div className="w-full bg-background1 border flex flex-row gap-x-6 rounded-xl hover:border-primary hover:shadow-sm hover:shadow-primary/60 p-6">
      {/* Image */}
      <img src={item.productImage} alt="" className="size-28 rounded-inherit" />
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="flex flex-row gap-x-4">
              <p className="text-sm text-foreground/60 bg-background rounded-md border border-border px-2 py-0.5">
                Size: {item.size.name}
              </p>
