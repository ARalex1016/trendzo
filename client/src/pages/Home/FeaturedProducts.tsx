...
const FeaturedProducts = () => {
    ...
    const [featuredProducts, setFeaturedProducts] = useState<IProduct[] | null>(null)
  ...
  return (
    <section className="w-full min-h-svh bg-card flex flex-col justify-center gap-y-10 px-side-spacing py-10">
        ...
        <div className='flex flex-col items-center gap-y-4 sm:gap-y-5'>
            ...
            <p className='max-w-5/5 sm:max-w-3/5 text-card-foreground/60 text-center'>Most loved products by our customers across Nepal</p>
        </div>
