...
const NoOrders = () => {
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-zinc-200 bg-white p-10 shadow-[0_20px_80px_rgba(0,0,0,0.08)] dark:border-zinc-800 dark:bg-zinc-900">
        {/* Background Glow */}
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="mt-3 max-w-md text-sm leading-6 text-zinc-500 dark:text-zinc-400">
            ...
            products and your orders will appear here beautifully.
          </p>
